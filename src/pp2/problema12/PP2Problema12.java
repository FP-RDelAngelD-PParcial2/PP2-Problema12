...
public class PP2Problema12 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i<n.length; i++){//Mientras que el valor de i sea menor que el tamaño del arreglo(9), i se aumentara en 1
            ...
            n[i]=entradaEscaner.nextInt();//En la pocision i se asigna el valor
                                          //Y regresa hasta que la posicion i se vuelva 9
        ...
        double promedio;
        promedio=0;
            for(int i=0; i<n.length; i++){ //Mientras que i sea menor que el tamaño del arreglo(9), i aumentara 1                                     
